...
const Footer = () => {
    return (
        <>
            <footer className="footer bg-sky-500 p-10 text-white font-poppins">
                <div>
                ...
                <div>
                    <span className="footer-title text-base">Company</span>
            ...
            <footer className="footer px-10 py-4 border-t bg-sky-600 text-white border-base-300 font-poppins">
                <div className="items-center grid-flow-col">
                    ...
                    <img src='https://wisata.sekeliling.com/logo-64.png' alt='logo64' width={50} />
                    <p>Wisata Sekeliling Ltd. <br />Providing reliable tech since 2022</p>
                </div>
